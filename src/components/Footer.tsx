      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div>
            ...
            <ul className="space-y-1.5">
              {[
                ...
                { label: 'Affordable Dumpster Rental', href: '/affordable-dumpster-rental' },
                ...
                { label: 'Is Dumpster Diving Legal?', href: '/is-dumpster-diving-legal' },
        ...
        <div className="border-t border-gray-800 pt-6 flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-4 text-xs text-gray-500">
            ...
            <Link href="/feed.xml" className="flex items-center gap-1 hover:text-orange-400 transition-colors" title="RSS Feed">
